...
export const mockAudits: MockAudit[] = [
  ...
  {
    id: 4,
    name: "Auditoría ISO 27001 - Seguridad TI",
    type: "etapa_1",
    status: "En progreso",
    progress: 60,
    ...
    description: "Auditoría etapa 1 para implementación de ISO 27001",
  },
  {
    id: 5,
    name: "Auditoría Extraordinaria - Cambio de Procesos",
    type: "extraordinaria",
    status: "Borrador",
    progress: 10,
    ...
    description:
      "Auditoría extraordinaria por cambios significativos en procesos",
  },
];
